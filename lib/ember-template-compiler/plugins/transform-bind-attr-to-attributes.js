...
var calculateLocationDisplay = require('../system/calculate-location-display');
var dasherize = require('../system/string');
...
function isBindAttrModifier(modifier, moduleName) {
  ...
  var moduleInfo = calculateLocationDisplay(moduleName, modifier.path.loc);
...
module.exports = TransformBindAttrToAttributes;
